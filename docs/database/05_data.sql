...
SELECT 'Chatbot Conversations: ' || COUNT(*) as info FROM chatbot_conversations;
SELECT 'Chat Messages: ' || COUNT(*) as info FROM chat_messages;
SELECT 'User Intents: ' || COUNT(*) as info FROM user_intents;
SELECT 'Chatbot Analytics: ' || COUNT(*) as info FROM chatbot_analytics;
